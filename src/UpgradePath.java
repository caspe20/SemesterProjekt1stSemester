public class UpgradePath {
    ...
    public String getUpgradeInfo() {
        if (currentLevel < upgrades.length) {
            ...
            s = s + upgrades[currentLevel].productionSpeed+ " plastic/yr >>> " + upgrades[currentLevel + 1].productionSpeed + " plastic/yr\n";
            return s;
        } else {
            String s = upgrades[currentLevel].upgradeName + "\n" + upgrades[currentLevel].productionSpeed + " plastic/yr";
            return s;
        }
    }
