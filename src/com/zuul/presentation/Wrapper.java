...
public class Wrapper {
    ...
    /**
     * Updates the progress bar in the upgradeRoom- and devilRoom scene, and cuts decimals off based on progress
    ...
    /**
     * Upgrades the first upgradable item in the current room and updates the UI to reflect this
     */
    ...
    /**
     * upgrade the second upgradable item in the current room and updates the UI to reflect this
     */
    ...
    /**
     * Changes the current room to Matas, such that upgrades and other items are available for that room
     */
    ...
    /**
     * Changes the current room to car dealer, such that upgrades and other items are available for that room
     */
    ...
    /**
     * Changes the current room to laundry mat, such that upgrades and other items are available for that room
     */
    ...
    /**
     * Changes the current room to dock, such that upgrades and other items are available for that room
     */
    ...
    /**
     * Changes the current room to devil room, such that upgrades and other items are available for that room
     */
